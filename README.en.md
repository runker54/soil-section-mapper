...
- 0.0.4 (2026-09-10) — dual fix for soil-color terrain rendering (band-snapshot data sync, low-elevation band clamp above X-axis), copyright in section-studio footer, sidebar numbering removed & restyled (status dot badges), parent-material mapping fixes
